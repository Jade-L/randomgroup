...
class PersonnesControllerTest < ActionController::TestCase
  ...
  test "should create personne" do
    assert_difference('Personne.count') do
      post :create, personne: { email: @personne.email, group_id: @personne.group_id, nom: @personne.nom, sensei: @personne.sensei, tel: @personne.tel }
    end
  ...
  test "should update personne" do
    patch :update, id: @personne, personne: { email: @personne.email, group_id: @personne.group_id, nom: @personne.nom, sensei: @personne.sensei, tel: @personne.tel }
    assert_redirected_to personne_path(assigns(:personne))
  end
